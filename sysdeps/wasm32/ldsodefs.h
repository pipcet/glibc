...
#include <dl-procinfo.c>
  ...
  int ( *_dl_catch_error) (const char **, const char **,
					    bool *, void (*) (void *), void *);
  void ( *_dl_signal_error) (int, const char *, const char *,
					      const char *);
  void (*_dl_mcount) (ElfW(Addr) frompc, ElfW(Addr) selfpc);
  lookup_t ( *_dl_lookup_symbol_x) (const char *,
						     struct link_map *,
						     const ElfW(Sym) **,
						     struct r_scope_elem *[],
...
/* Count DSTs.  */
extern size_t _dl_dst_count (const char * is_path) attribute_hidden;

/* Substitute DST values.  */
extern char *_dl_dst_substitute (struct link_map *l, const char *, char *result) attribute_hidden;
...
extern void _dl_add_to_slotinfo (struct link_map  *l, bool do_add) attribute_hidden;
